...
def main():
    ...
    try:
        ...
        scene = service(req)
        rest_joints_right = np.array([0.0,-90.0, 0.0, 45.0,45.0, 90.0,0.0]) * math.pi / 180.0
        result = gr.moveToJointPosition(jts_right, rest_joints_right, plan_only=False, wait=True, max_velocity_scaling_factor=0.1)
        print(result)
